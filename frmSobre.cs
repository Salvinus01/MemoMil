...
namespace MemoMil
{
  internal class frmSobre : Form
  {
    ...
    public frmSobre()
    {
      ...
      this.Text = string.Format("Sobre {0}", (object) this.AssemblyTitle);
    ...
    private void InitializeComponent()
    {
      ...
      this.logoPictureBox.Image = (Image) Resources.Ops;
      ...
      this.Name = nameof (frmSobre);
      this.Padding = new Padding(9);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = nameof (frmSobre);
